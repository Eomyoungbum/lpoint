...
public class EmpRepository implements IEmpRepository {
	...
	public int getEmpCount(int deptid) {
		...
		return jt.queryForObject(sql, Integer.class, deptid);
	}

	@Override
	public List<EmpVO> getEmpList() {
		String sql = "select * from employees";
		return jt.query(sql, new EmpMapper());
	}
	...
	public EmpVO getEmpInfo(int empid) {
		...
		return jt.queryForObject(sql, new EmpMapper(), empid);
	}
	...
	public void updateEmp(EmpVO emp) {
		...
		jt.update(sql, emp.getFirstName(), emp.getLastName(), emp.getEmail(), emp.getPhoneNumber(), emp.getHireDate(), emp.getJobId(), emp.getSalary(), emp.getCommissionPct(), emp.getManagerId(), emp.getDepartmentId(), emp.getEmployeeId());
	}

	@Override
	public void insertEmp(EmpVO emp) {
		String sql = "insert into employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, commission_pct, manager_id, department_id) values(?,?,?,?,?,sysdate,?,?,?,?,?)";
		jt.update(sql, emp.getEmployeeId(), emp.getFirstName(), emp.getLastName(), emp.getEmail(), emp.getPhoneNumber(), emp.getJobId(), emp.getSalary(), emp.getCommissionPct(), emp.getManagerId(), emp.getDepartmentId());
	}
	...
	public int deleteEmp(int empid, String email) {
		...
		return jt.update(sql, empid, email);
	}
